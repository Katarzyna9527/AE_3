function [net]= train_net(train_set,labels,hidden_neurons_count)
    ...
    net.IW{1,1} = random('Uniform',-0.15,0.15,hidden_neurons_count,1); 
    net.LW{2,1} = random('Uniform',-0.15,0.15,1,hidden_neurons_count);
    net.b{1,1} = random('Uniform',-0.15,0.15,hidden_neurons_count,1);
    net.b{2,1} = random('Uniform',-0.15,0.15,1,1);
